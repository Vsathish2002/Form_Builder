...
//               )}
//             </div>
//             <ul className="text-sm text-gray-500 grid sm:grid-cols-3 gap-2">
//               <li>No credit card needed</li>
//               <li>Unlimited responses on Free</li>
...
//               className="w-80 h-64 md:w-[28rem] md:h-[22rem] object-contain"
//               loading="lazy"
...
//         <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-2 text-gray-500 text-sm">
//           <span>Trusted by creators, teams, and startups</span>
...
//       <div className="container mx-auto px-4">
//         <motion.h2 initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fromBottom} className="text-3xl font-extrabold text-blue-700 text-center mb-8">
//           Features
//         </motion.h2>
...
//               whileInView="visible"
//               viewport={{ once: true }}
//               variants={idx % 2 === 0 ? fromLeft : fromRight} // alternate left/right
...
//           {steps.map((s, idx) => {
//             const variant = idx === 0 ? fromLeft : idx === 1 ? fromBottom : fromRight;
//             return (
//               <motion.div
//                 key={s.n}
//                 initial="hidden"
...
//                 {...hoverLift}
//               >
//                 <div className="h-12 w-12 bg-blue-600 text-white flex items-center justify-center rounded-full font-bold text-lg mb-3">
//                   {s.n}
//                 </div>
...
//               whileInView="visible"
//               viewport={{ once: true }}
//               variants={idx % 2 === 0 ? fromLeft : fromRight}
//               className="rounded-xl border border-blue-100 bg-white p-5 hover:shadow-lg transition cursor-pointer"
//               {...hoverLift}
//             >
//               <div className="aspect-video rounded-lg bg-gradient-to-br from-blue-100 to-blue-50 mb-3" />
...
//         <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fromLeft}>
//           <h3 className="text-2xl font-bold text-blue-700">Instant Insights</h3>
//           <p className="text-gray-600 mt-2">
//             See completions, drop-off by question, device breakdowns, and export ready-to-share charts. Track trends with filters and time ranges.
//           </p>
//           <ul className="mt-4 text-gray-700 space-y-2 text-sm">
//             <li>Response timeline and completion rate</li>
//             <li>Top sources: link, QR, embeds</li>
//             <li>Export CSV/PDF, share snapshot</li>
//           </ul>
//         </motion.div>
//         <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fromRight} className="rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 to-white h-64" />
//       </div>
//     </section>
//   );
// }
...
//         <motion.h2 initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fromTop} className="text-4xl md:text-5xl font-extrabold">
//           Start Creating Forms Today
//         </motion.h2>
//         <motion.p initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fromBottom} className="text-lg md:text-xl">
  ...
  return (
    <section id="templates" className="py-14">
      <div className="container mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {templates.map((t, idx) => (
            <motion.div key={idx} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={idx % 2 === 0 ? fromLeft(idx*0.2) : fromRight(idx*0.2)} className="rounded-xl border border-blue-100 bg-white p-5 hover:shadow-lg transition cursor-pointer" {...hoverLift}>
              <div className="aspect-video rounded-lg bg-gradient-to-br from-blue-100 to-blue-50 mb-3" />
              <div className="font-semibold">{t.name}</div>
              <div className="text-sm text-gray-500">Use template</div>
            </motion.div>
